...
function response(room, msg, sender, isGroupChat, replier) {
  ...
  if (Data[0] == "!히스" || Data[0] == "!ㅎㅅ") {
    try {
      ...
      const yesterday = new Date(today.setDate(today.getDate() - 0.5));

      function sevenDay(e) {
        const year = yesterday.getFullYear();
        const month = (yesterday.getMonth() + 1).toString().padStart(2, "0");
        const day = yesterday.getDate().toString().padStart(2, "0") - e;
      ...
      let dayM1 = sevenMiniDay(0);
      let dayM2 = sevenMiniDay(1);
      let dayM3 = sevenMiniDay(2);
      let dayM4 = sevenMiniDay(3);
      let dayM5 = sevenMiniDay(4);
      let dayM6 = sevenMiniDay(5);
      let dayM7 = sevenMiniDay(6);
