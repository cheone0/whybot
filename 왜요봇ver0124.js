    ...
    if (Data[1] == "1") {
      try {
        ...
        var mapleG = org.jsoup.Jsoup.connect(
          "https://maplestory.nexon.com/Common/Guild?gid=934534&wid=3"
        )
          .get()
  ...
  if (Data[0] == "!편안랭킹") {
    if (Data[1] == "1") {
      try {
        var rankList = [];
        var mapleG = org.jsoup.Jsoup.connect(
          "https://maplestory.nexon.com/Common/Guild?gid=8893&wid=50"
        )
          .get()
          .select("div.guild_user_list")
          .select("tbody");
    ...
    if (Data[1] == "2") {
      try {
        var rankList = [];
        var mapleG = org.jsoup.Jsoup.connect(
          "https://maplestory.nexon.com/Common/Guild?gid=8893&wid=50&orderby=0&page=2"
        )
          .get()
          .select("div.guild_user_list")
          .select("tbody");
    ...
    if (Data[1] == "3") {
      try {
        var rankList = [];
        var mapleG = org.jsoup.Jsoup.connect(
          "https://maplestory.nexon.com/Common/Guild?gid=8893&wid=50&orderby=0&page=3"
        )
          .get()
          .select("div.guild_user_list")
          .select("tbody");
    ...
    if (Data[1] == "4") {
      try {
        var rankList = [];
        var mapleG = org.jsoup.Jsoup.connect(
          "https://maplestory.nexon.com/Common/Guild?gid=8893&wid=50&orderby=0&page=4"
        )
          .get()
          .select("div.guild_user_list")
          .select("tbody");
